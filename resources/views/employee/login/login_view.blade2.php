...
<body id="top">
        ...
        <div class="container">
            <div class="row login-box">
                <div class="col-lg-7 col-md-12 form-info">
                    <img src="{{ asset('assets') }}/img/accleron.png" alt="logo"
                        style="width: 35%; margin-top: -70px;margin-left: -61px;">
                    <div class="form-section">
                        ...
                        <h3 class="mb-3">Employee Sign in</h3>
                            ...
                            <form name="loginForm" id="loginForm">
                                ...
                                <div class="form-group form-box">
                                    <input type="text" name="emp_code" id="emp_code" class="form-control"
                                        placeholder="Employee Code" aria-label="emp_code">
                                    <i class="flaticon-user"></i>
                                    <div class="invalid-feedback d-block text-start px-2" id="emp_code_error">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="input-group ">
                                            <input class="captcha-container float-center form-control p-0 text-center"
                                                id="captcha" value="{!! $operand1 . ' + ' . $operand2 !!}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-2 ">

                                        <button type="button" class="btn-floating" id="reload"><i
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group ">
                                            <input type="text" class="form-control float-right "
                                                placeholder="Enter captcha" name="captcha_input" id="captcha_input"
                                                autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="invalid-feedback d-block text-start px-2 mb-5" id="captcha_input_error">
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <button class="btn-md btn-theme w-100 d-none" type="button" id="loader_btn"
                                        style="background-color: #3b3838;">
                ...
                <div class="col-lg-5 col-md-12 bg-img">
                    <div class="info">
                        {{-- <div class="info-text">
                            <div class="waviy">
                                <span style="--i:1; color: #000;">E</span>
                                <span style="--i:2; color: #000;">m</span>
                                <span style="--i:3; color: #000;">p</span>
                                <span style="--i:4; color: #000;">l</span>
                                <span style="--i:5; color: #000;">o</span>
                                <span style="--i:6; color: #000;">y</span>
                                <span style="--i:7; color: #000;">e</span>
                                <span style="--i:8">t</span>
                                <span style="--i:9">o</span>
                                <span style="--i:10; color: #000;">L</span>
                                <span style="--i:11; color: #000;">O</span>
                                <span style="--i:12; color: #000;">G</span>
                                <span style="--i:13; color: #000;">I</span>
                                <span style="--i:13; color: #000;">N</span>
    ...
    <script src="{{ asset('assets') }}/login-assets/js/employee_login.js"></script>
