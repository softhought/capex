        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <div class="app-brand demo ">
                    <a href="{{ url('/admin/dashboard') }}" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bold ms-2 text-uppercase ">Admin Panel</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    @php
                        ...
                        $roleId = $pptcAdmin['roleId'];
                        $name = $pptcAdmin['userName'];
                        $role = $pptcAdmin['role'];
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="bs-toast toast toast-success toast-ex animate__animated my-2" role="alert"
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <x-admin.modal-layout id="commonModal" title="Add"
                            dialogclass="modal-lg modal-dialog-centered" bodyclass="an-box-shadow">

                        </x-admin.modal-layout>

                        <x-admin.modalleft-layout id="commonLeftModal" title="Add"
                        dialogclass="modal-lg modal-dialog-centered" bodyclass="an-box-shadow">

                         </x-admin.modalleft-layout>
